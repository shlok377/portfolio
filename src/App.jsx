...
function App() {
  ...
  return (
    ...
    >
      ...
      <div className="text-white selection:bg-primary selection:text-white bg-black">
        {/* Hero Section */}
        <section id="home" className="relative min-h-screen overflow-hidden" style={{ background: colors.backgroundGradient || colors.background }}>
